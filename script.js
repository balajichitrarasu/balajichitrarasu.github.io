window.addEventListener('load', function () {
  ...
  /* 7. STATS COUNTER — always reaches exact target */
  var counted = false;
  ...
  if (sendBtn) {
    sendBtn.addEventListener('click', function () {
      ...
      if (!name || !email || !msg) { showMsg('err', 'Please fill in all fields.'); return; }
      ...
      showMsg('ok', 'Mail app opened! You can also email: balajihck20@gmail.com');
    });
  }
