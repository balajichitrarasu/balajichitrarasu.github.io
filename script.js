...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function renderSkills() {
    ...
    container.innerHTML = skills.map(function (s) {
      var iconSrc = (s.icon && s.icon.length > 2 && s.icon !== 'amazonaws')
        ? 'https://cdn.simpleicons.org/' + s.icon
        : (s.icon === 'amazonaws' ? "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%2338bdf8'%3E%3Cpath d='M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z'/%3E%3C/svg%3E" : '');
      var iconEl = iconSrc
